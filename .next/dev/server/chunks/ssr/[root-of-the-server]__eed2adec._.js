...
const fetchNotes = async (id, search, page, perPage)=>{
    await delay(2000);
...
const fetchNoteById = async ({ params })=>{
    const { id } = await params;
    console.log('note id:', id);
};
const __TURBOPACK__default__export__ = fetchNoteById;
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eed2adec._.js.map